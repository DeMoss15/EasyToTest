...
import com.demoss.edqa.presentation.adapter.TestsRecyclerViewAdapter
import com.demoss.edqa.presentation.main.dialog.PasswordVerificationFragment
import com.demoss.edqa.presentation.main.dialog.SimpleItemsListDialogFragment
import com.demoss.edqa.presentation.main.main.MainCallback
import com.demoss.edqa.presentation.main.settings.SettingsActivity
import com.demoss.edqa.util.Constants
import com.demoss.edqa.util.EmptyConstants
import com.demoss.edqa.util.pagination.setOnNextPageListener
...
class TestsFragment : BaseFragment<TestsContract.Presenter>(), TestsContract.View {
    ...
    companion object {
        const val TAG = "com.demoss.edqa.tests_fragment"
    ...
    override fun share(string: String, testName: String) {
        context?.let {
            ...
            val path = FileProvider.getUriForFile(it, "com.demoss.edqa.fileprovider", file)
